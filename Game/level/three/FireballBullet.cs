...
public class FireballBullet : FlyingProjectile<Enemy3>    
{
    public FireballBullet(Vector2 startPosition, Vector2 direction, float shotDuration, float shotVelocity,
    ...
    public FireballBullet() : this(Vector2.Zero, Vector2.Zero, 0f, 0f, 0f, 0, Vector2.Zero)
    {
    }
