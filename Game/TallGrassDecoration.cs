...
public class TallGrassDecoration() : WorldFeature("tall-grass-decoration"), ICollidable
{
    private static readonly Texture2D Tex = EmbeddedTexture.LoadTexture("Game.level.two.tall-grass.png")!.Value;
