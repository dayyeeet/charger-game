...
public class Chest() : DestroyableObject("level-three-chest", 50)
{
    private static readonly Texture2D Tex = EmbeddedTexture.LoadTexture("Game.level.three.chest.png")!.Value;
