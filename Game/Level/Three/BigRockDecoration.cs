...
public class BigRockDecoration (): WorldFeature("level-three-rock-one-decoration"), ICollidable
{
    private static readonly Texture2D Tex = EmbeddedTexture.LoadTexture("Game.level.three.big-rock.png")!.Value;
