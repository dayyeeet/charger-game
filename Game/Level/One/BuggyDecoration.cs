...
public class BuggyDecoration() : WorldFeature("car-decoration"), ICollidable
{
    private static readonly Texture2D Tex = EmbeddedTexture.LoadTexture("Game.level.one.buggy.png")!.Value;
