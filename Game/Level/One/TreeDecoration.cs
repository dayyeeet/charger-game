...
public class TreeDecoration (): WorldFeature("level-one-tree-decoration"), ICollidable
{
    private static readonly Texture2D Tex = EmbeddedTexture.LoadTexture("Game.level.one.tree.png")!.Value;
