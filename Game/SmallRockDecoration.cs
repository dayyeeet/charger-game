...
public class SmallRockDecoration() : WorldFeature("small-rock-decoration"), ICollidable
{
    private static readonly Texture2D Tex = EmbeddedTexture.LoadTexture("Game.small-rock.png")!.Value;
    public override int ElementWidth { get; set; } = 48;
    public override int ElementHeight { get; set; } = (int)(48.0 * ((double)Tex.Height / Tex.Width));
