...
public class GreenPlasmaBullet(
    ...
    Predicate<GameObject>? collisionFilter = null) : FlyingProjectile<Player>(startPosition, direction, shotDuration, shotVelocity,
    damageAmount,
    maxDistance, color, currentPosition, collisionFilter)
{
    public GreenPlasmaBullet() : this(Vector2.Zero, Vector2.Zero, 0f, 0f, 0f, 0, Color.White, Vector2.Zero)
    {
    }
